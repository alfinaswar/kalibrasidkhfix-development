                        ...
                        <div class="row">
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <select name="Status" class="form-control @error('Status') is-invalid @enderror">
                                    ...
                                    <option value="DISETUJUI" @if ($data->Status == 'DISETUJUI') selected @endif>Disetujui
                                    </option>
                                    <option value="DITOLAK" @if ($data->Status == 'DITOLAK') selected @endif>Tidak
                                        Disetujui</option>
                                </select>
                                @error('Status')
                                    <span class="invalid-feedback" role="alert">
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <input type="text" name="Perihal" id="" class="form-control"
                                    placeholder="Isi Perihal" value="{{ $data->Perihal }}">
                            </div>
                            <div class="mb-3 col-md-6">
                                <label class="form-label">Lampiran</label>
                                <input type="text" name="Lampiran" id="" class="form-control"
                                    placeholder="Lampiran" value="{{ $data->Lampiran }}">
                            </div>
                            <div class="mb-3 col-md-6">
