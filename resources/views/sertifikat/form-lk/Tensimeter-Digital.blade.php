...
@section('content')
    ...
    <script>
        ...
        $('.forminput').on('input', function() {
            ...
            var titikUkur = parseFloat($(this).closest('tr').find('input[name="Titik_Ukur_Hasil[]"]').val());
            ...
            if (pengulangan3 < batasBawah || pengulangan3 > batasAtas) {
                ...
                $(this).closest('tr').find('input[name="Pengulangan3_Tekanan_Darah[]"]').removeClass(
                    'is-invalid');
            }
        });
    </script>
