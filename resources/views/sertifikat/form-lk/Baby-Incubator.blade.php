        ...
        $(document).ready(function() {
            ...
            $('.forminput').on('input', function() {
                ...
                var pengulangan1 = parseFloat($(this).closest('tr').find(
                    'input[name="Pengulangan1A[]"]').val());
                var pengulangan2 = parseFloat($(this).closest('tr').find(
                    'input[name="Pengulangan2A[]"]').val());
                var pengulangan3 = parseFloat($(this).closest('tr').find(
                    'input[name="Pengulangan3A[]"]').val());
                var pengulangan4 = parseFloat($(this).closest('tr').find(
                    'input[name="Pengulangan4A[]"]').val());
                var pengulangan5 = parseFloat($(this).closest('tr').find(
                    'input[name="Pengulangan5A[]"]').val());
                var titikUkur = $('#param1').val();
                console.log(titikUkur);
                var titikUkur2 = $('#param2').val();
                console.log(titikUkur);


                var batasBawah = titikUkur - 0.8;
                var batasAtas = titikUkur + 0.8;

                var batasBawah2 = titikUkur2 - 0.8;
                var batasAtas2 = titikUkur2 + 0.8;

                if (pengulangan1 < batasBawah || pengulangan1 > batasAtas) {
                    $(this).closest('tr').find('input[name="Pengulangan1A[]"]').addClass(
                        'is-invalid');
                } else {
                    $(this).closest('tr').find('input[name="Pengulangan1A[]"]').removeClass(
                        'is-invalid');
                }

                if (pengulangan2 < batasBawah || pengulangan2 > batasAtas) {
                    $(this).closest('tr').find('input[name="Pengulangan2A[]"]').addClass(
                        'is-invalid');
                } else {
                    $(this).closest('tr').find('input[name="Pengulangan2A[]"]').removeClass(
                        'is-invalid');
                }

                if (pengulangan3 < batasBawah || pengulangan3 > batasAtas) {
                    $(this).closest('tr').find('input[name="Pengulangan3A[]"]').addClass(
                        'is-invalid');
                } else {
                    $(this).closest('tr').find('input[name="Pengulangan3A[]"]').removeClass(
                        'is-invalid');
                }
                if (pengulangan4 < batasBawah || pengulangan4 > batasAtas) {
                    $(this).closest('tr').find('input[name="Pengulangan4A[]"]').addClass(
                        'is-invalid');
                } else {
                    $(this).closest('tr').find('input[name="Pengulangan4A[]"]').removeClass(
                        'is-invalid');
                }
                if (pengulangan5 < batasBawah || pengulangan5 > batasAtas) {
                    $(this).closest('tr').find('input[name="Pengulangan5A[]"]').addClass(
                        'is-invalid');
                } else {
                    $(this).closest('tr').find('input[name="Pengulangan5A[]"]').removeClass(
                        'is-invalid');
                }
            });
        });
