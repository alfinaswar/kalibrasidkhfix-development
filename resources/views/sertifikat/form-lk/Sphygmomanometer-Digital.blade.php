...
@section('content')
    ...
    <script>
        ...
        $('.ujikebocoran').on('input', function() {
            this.value = this.value.replace(/[^0-9.,]/g, '').replace(/(\..{2})/g, '$1');
            var pengulangan1 = parseFloat($(this).val());
            var titikUkur = 250;

            var batasBawah = titikUkur - 15;
            var batasAtas = titikUkur + 15;
        ...
        $('.waktuinput').on('input', function() {
            this.value = this.value.replace(/[^0-9.,]/g, '').replace(/(\..{2})/g, '$1');
            var pengulangan1 = parseFloat($(this).val());
            var titikUkur = 10;

            if (pengulangan1 > titikUkur) {
                $(this).addClass('is-invalid');
            } else {
                $(this).removeClass('is-invalid');
            }
