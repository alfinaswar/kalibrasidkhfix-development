                            ...
                            @if ($row == 0)
                                ...
                                <td>
                                    <input type="text" class="form-control" name="Titik_Ukur_Nama[]"
                                        value="{{ $titikUkur[$counter] }}" readonly>
                                </td>
                                ...
                                <td><input type="text" class="form-control" name="Pengulangan1_Tekanan_Darah[]"
                                        placeholder="Hasil"
                                        value="{{ $sertifikat->getPengujianTensimeterDigital[$counter]->Pengulangan1 ?? '' }}">
                                </td>
                                <td><input type="text" class="form-control" name="Pengulangan2_Tekanan_Darah[]"
                                        placeholder="Hasil"
                                        value="{{ $sertifikat->getPengujianTensimeterDigital[$counter]->Pengulangan2 ?? '' }}">
                                </td>
                                <td><input type="text" class="form-control" name="Pengulangan3_Tekanan_Darah[]"
                                        placeholder="Hasil"
                                        value="{{ $sertifikat->getPengujianTensimeterDigital[$counter]->Pengulangan3 ?? '' }}">
                                </td>
                                <td rowspan="3">±
                                    5&nbsp;&nbsp;&nbsp;mmHg</td>
                            @else
                                ...
                                <td><input type="text" class="form-control" name="Pengulangan3_Tekanan_Darah[]"
                                        placeholder="Hasil"
                                        value="{{ $sertifikat->getPengujianTensimeterDigital[11]->Pengulangan3 ?? '' }}">
                                </td>
                            @endif
                        </tr>
                        @php $counter++; @endphp
