...
return new class extends Migration {
    ...
    {
        Schema::create('sertifikat_centrifuge_pengujians', function (Blueprint $table) {
            $table->id();
            $table->string('SertifikatId')->nullable();
            $table->bigInteger('InstrumenId')->nullable();
            $table->enum('TipePenujian', ['RPM', 'TIME'])->nullable();
    ...
    {
        Schema::dropIfExists('sertifikat_centrifuge_pengujians');
    }
};
